  ...
  <div className="max-w-6xl mx-auto text-center">
    ...
    <div className="flex flex-wrap justify-center items-center gap-8 px-4">
      ...
      <div className="bg-gray-100 p-6 rounded-lg shadow-lg hover:bg-gray-300 transition duration-300 w-full sm:w-1/2 md:w-1/3">
        ...
        <a download={'https://1drv.ms/b/s!AockudgJfm9WgjcVBQ2en4HKDc5y?e=hJjagd'}  href={'https://1drv.ms/b/s!AockudgJfm9WgjcVBQ2en4HKDc5y?e=hJjagd'} target="_blank" className="inline-block px-4 py-2 rounded-lg  transition duration-300">
      ...
      <div className="bg-gray-100 p-6 rounded-lg shadow-lg hover:bg-gray-300 transition duration-300 w-full sm:w-1/2 md:w-1/3">
        ...
        <a href={'https://1drv.ms/b/s!AockudgJfm9WgjcVBQ2en4HKDc5y?e=hJjagd'} target="_blank" className="inline-block  px-4 py-2 rounded-lg  transition duration-300">
        <button className="text-lg px-10 flex gap-5 hover:bg-white hover:text-black py-1.5 items-center rounded-full font-light bg-black text-white ">
